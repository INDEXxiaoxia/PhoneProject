...
<head>
    ...
    <meta name="description"
          content="回购网是一家专业安全的二手手机回收网，为您提供在线手机回收、平板电脑回收、笔记本回收、数码相机回收、相机镜头回收、无人机回收，专业手机回收价格评估，让你轻松买卖二手手机等闲置数码产品。"/>
...
<%--<form name="myFrom" id="myFrom" method="post" action="/order/sub.html">--%>
    ...
    <!--提交订单========&&&&&%%%%%%%%%%%%%&&&&&&&&&&&%%%%%%%%%%%%%-->
    <%--<input type="hidden" name="isAll">--%>
    <form action="/buy/success" method="post" id="toSuccess">
        <input type="hidden" name="Sessionuid" value="${sessionScope.userInSession.uid}">
        <input type="hidden" name="isAll" value="${packageOrders.size()}">
        <input type="hidden" name="incar" value="${packageOrders.get(0).incar}">
            ...
            <div style="padding:0 15px;">
                ...
                <div class="areas_flow">
                    <div class="c_1" id="m1" onclick="aa(1)">
                        <ul class="bor_right">
                            <li class="bor_img"><IMG src="/static/images/img_1_1.png"></li>
                        </ul>
                        <ul class="bor_left">
                    ...
                    <div class="c_0" id="m2" onclick="aa(2)">
                        <ul class="bor_right">
                            <li class="bor_img"><IMG src="/static/images/img_2_1.png"></li>
                        </ul>
                        <ul class="bor_left">
                    ...
                    <div class="c_0" id="m3" onclick="aa(3)" style="border:none">
                        <ul class="bor_right">
                            <li class="bor_img"><IMG src="/static/images/img_3_1.png"></li>
                        </ul>
                        <ul class="bor_left">
                ...
                <!--切换-->
                <div class="process block" id="t1"><img src="/static/images/liucheng1_1.jpg"/></div>
                <div class="process none" id="t2"><img src="/static/images/liucheng2.jpg"/></div>
                <div class="process none" id="t3"><img src="/static/images/liucheng3_1.jpg"/></div>
                <div class="ihuigo">
                    <!-- 通用联系方式start-->
                    <div class="sub_con_top">
                        ...
                        <div class="contanct_c check" name="item_member_addr" id="item_member_addr_0">
                            <label>
                                <input type="radio" name="member_addr" value="0" checked="checked"
                                       onClick="new_member_addr(0)"/>
                        ...
                        <div id="new_member_addr_div">
                            ...
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="/static/images/in_1.gif"></span><span class="img_2">
                                <input name="callman" id="link_name" type="text"></span>
                                    <span class="img_1"><IMG src="/static/images/in_3.gif"></span><span
                                            class="img_3"><em
                                            style="color: red; font-size:12px;margin-right: 10px;">*</em></span></li>
                                <div class="clear"></div>
                            </ul>
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="/static/images/in_1.gif"></span><span class="img_2">
                                <input name="callnum" id="mobile" type="text"></span>
                                    <span class="img_1"><IMG src="/static/images/in_3.gif"></span><span
                                            class="img_3"><em
                                            style="color: red; font-size:12px;margin-right: 10px;">*</em></span></li>
                                <div class="clear"></div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="select_box">
                                            <span class="select_txt" id="text_province">请选择省份</span><em
                                                class="selet_open"><b></b></em>
                                    ...
                                    <li>
                                        <div class="select_box">
                                            <span class="select_txt" id="text_city">请选择城市</span><em
                                                class="selet_open"><b></b></em>
                                    ...
                                    <li>
                                        <div class="select_box">
                                            <span class="select_txt" id="text_district">请选择区县</span><em
                                                class="selet_open"><b></b></em>
                                            <input type="hidden" id="district" name="district" value="0"/>
                                            <input type="hidden" id="school_id" name="school_id" value="0"/>
                                            <div class="option" style="position:absolute;right:0 !important; "
                                                 id="option_district">
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div>
                                <ul class="contact_list">
                                    ...
                                    <li class="contact_texts"><span class="img_1"><img
                                            src="/static/images/in_1.gif"></span><span class="img_2_area">
                                    <input name="aaddrr" id="address" type="text"></span> <span class="img_1"><IMG
                                            src="/static/images/in_3.gif"></span></li>
                                    <div class="clear"></div>
                                </ul>
                            </div>
                        </div>
                        <link rel="stylesheet" type="text/css" href="/static/js/calendar/calendar.css"/>
                        ...
                        <div class="contact_list" style="margin-top:20px;">
                            <div id="div_addr" style="display:none;">
                                ...
                                <ul class="area_list">
                                    <li class="area_list_texts"><input name="stime" id="stime" type="text"
                                                                       style="border:0px;"
                                                                       onfocus="return showCalendar('stime', '%Y-%m-%d %H:%m', '24', false, 'stime');"
                                                                       value=""></li>
                                ...
                                <ul class="area_list">
                                    <li class="area_list_texts">
                                        <input name="etime" id="etime" type="text" style="border:0px; "
                                               onfocus="return showCalendar('etime', '%Y-%m-%d %H:%m', '24', false, 'etime');"
                                               value="">
                                    </li>
                                    <li class="area_list_bg"></li>
                                </ul>
                            ...
                            <div class="kuaidi"><!--<a href="###" class="on">回购网联系快递</a>-->
                                <input type="checkbox" value='y' name="express_true" id="express_true"
                                       onclick="express_true_click()"/><label for="express_true">回购网联系快递</label>
                            </div>
                            <script>
                    ...
                    <div id="s1" class="block">
                        ...
                        <div class="sub_con_foot">
                            ...
                            <div class="contanct_c check" name="item_member_bank" id="item_member_bank_0">
                                <label>
                                    <input type="radio" name="member_bank" value="0" checked="checked"
                                           onClick="new_member_bank(0)"/>
                            ...
                            <div id="new_member_bank_div">
                                ...
                                <div class="contact_list">
                                    <ul>
                                        ...
                                        <li class="contact_select">
                                            ...
                                            <span class="img_3"><em
                                                    style="color: red; font-size:12px;margin-right: 10px;">*</em></span>
                                        </li>
                                        <div class="clear"></div>
                                    </ul>
                                </div>
                                ...
                                <ul class="contact_list">
                                    ...
                                    <li class="contact_texts"><span class="img_1"><img
                                            src="/static/images/in_1.gif"></span><span class="img_2"><input
                                            name="realname"
                                            id="realname"
                                            type="text"></span>
                                        <span class="img_1"><IMG src="/static/images/in_3.gif"></span><span
                                                ...
                                                style="color: red; font-size:12px;margin-right: 10px;">*</em></span>
                                        <span
                                                class="contact_textsval">开户时的真实姓名</span></li>
                                    <div class="clear"></div>
                                </ul>
                                <ul class="contact_list" style="position:relative">
                                    ...
                                    <li class="contact_texts"><span class="img_1"><img
                                            ...
                                            id="card_sn"
                                            type="text"
                                            onkeyup="show_card_sn_format()"
                                            onfocus="show_card_sn_format()"
                                            onblur="card_sn_blur()"></span>
                                        <span class="img_1"><IMG src="/static/images/in_3.gif"></span><span
                                                class="img_3"><em
                                                style="color: red; font-size:12px;margin-right: 10px;">*</em></span>
                                        <span
                                                class="contact_textsval">我们对用户帐号信息严格保密，请放心填写！</span></li>
                                    <div class="clear"></div>

                                    <div id="card_sn_format"
                                         style="display:none;position:absolute; left:100px; top:-26px; z-index:10000; border:1px solid #ccc; background:#fff9c9; height:24px; line-height:24px; padding:0 5px; font-size:16px; color:#2056ff; font-weight:bold; font-family:"
                                         微软雅黑
                                    ";">
                            </div>
                            </ul>
                    ...
                    <div class="sub_con_foot">
                        <div class="contact_ways m_unclock">
                            ...
                            <div class="alertTips">
                                ...
                                <p>魅族手机关闭Flyme:<span>方法1：设置-账户-退出账户</span><span>方法2：打开Flyme官网登录-云服务-登录选择机型-远程退出 </span>
                                </p>
                            </div>
                        </div>
                        <div style="padding-left:100px; margin-bottom:15px;">
                            <input style="width:410px;padding:3px 10px;display:none;" type="text" name="pwd"
                                   placeholder="请提供开机密码和iCloud或Flyme账号密码（备注类型并以空格间隔）">
                    ...
                    <div class="sub_con_foot">
                        ...
                        <div id="new_member_alipay_div">
                            ...
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="/static/images/in_1.gif"></span><span class="img_2">
                                <input name="realname" id="alipay_realname" type="text" value=""></span> <span
                                        class="img_1"><IMG src="/static/images/in_3.gif"></span><span class="img_3"><em
                                        style="color: red; font-size:12px;margin-right: 10px;">*</em></span></li>
                                <div class="clear"></div>
                            </ul>
                            ...
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="/static/images/in_1.gif"></span><span class="img_2">
                                <input
                                        name="paynum" id="alipay_username" type="text" value=""></span> <span
                                        class="img_1"><IMG src="/static/images/in_3.gif"></span><span class="img_3"><em
                                        style="color: red; font-size:12px;margin-right: 10px;">*亲，必须是实名认证的支付宝账号哦！</em></span>
                                </li>
                                <div class="clear"></div>
                            </ul>
                        </div>
                ...
                <div id="s3" class="none">
                    <!-- 回购点start-->
                    <div class="sub_con_foot">
                        <div class="contact_ways">面交方式(目前仅支持<b style="color:#f60">深圳</b>地区当面交易，其它地区请选择<b
                                style="color:#f60">官方担保交易</b>)
                        </div>

                        <div class="contanct_c check" id="div_mianjiao_method_1">
                            <label>
                                <input type="radio" name="mianjiao_method" id="mianjiao_method_1" value="1"
                                       checked="checked" onClick="mianjiao_method_click(1)"/>
                        ...
                        <div class="contanct_c" id="div_mianjiao_method_2">
                            <label>
                                <input type="radio" name="mianjiao_method" id="mianjiao_method_2" value="2"
                                       onClick="mianjiao_method_click(2)"/>
                                <span style="font-weight:bold;">上门面交</span>
                                <span>目前支持福田区，罗湖区，南山区（建议选择地铁口面交）</span>
                            </label>
                        </div>

                        <link href="/static/js/new_js/My97DatePicker/skin/WdatePicker.css" rel="stylesheet"
                              type="text/css"/>
                        <script src="/static/js/new_js/My97DatePicker/WdatePicker.js" type="text/javascript"></script>

                        <div class="contanct_c" id="go_mianjiao_method_2" style="display:none;">
          	<span>上门日期：<input name="yu_time" id="yu_time" type="text" onfocus="return WdatePicker();"
                              style="width:80px;">
                                    <em style="padding-left:0px;"><input type="radio" name="mianjiao_hour" value="1"
                                                                         style="vertical-align:middle"/><i>09:00-12:00</i><div
                                            class="clear"></div></em>
                        <em><input type="radio" name="mianjiao_hour" value="2" style="vertical-align:middle"/><i>12:00-18:00</i><div
                                class="clear"></div></em>
                        <em><input type="radio" name="mianjiao_hour" value="3" style="vertical-align:middle"/><i>18:00-21:00</i><div
                                class="clear"></div></em>
                                    </span>
                            <span>沿途临近（地铁）：
      ...
      您可选择<a href="http://www.ihuigo.com/html/baoxian.html"
             style="background:none; padding:0px; color:#03F; font-weight:bold;"
             target="_blank">参与中国人民财产保险投保计划</a></span>
                &nbsp;&nbsp;
                <label><a href="/service/legal.html" target="_blank" class="on">我已查看并同意回收协议</a></label>
                <script type="text/javascript">
                    function toSuccessView() {
                        // alert("aaaaa")
                        $("#toSuccess").submit();
                    }
                </script>
                <input type="button" name="sub_button" id="sub_button" value="提交回购单" class="input_btn2"
                       onclick="toSuccessView()"/>
            </div>

            <dl id="baoxian_content" style="display:none;">
                <dt><span>请输入您的姓名和身份证号，以生成中国人保保单</span></dt>
                <dd><span>姓&nbsp;&nbsp;&nbsp;名：</span><input type="text" name="baoxian_name" id="baoxian_name"
                                                             value=""/>
                </dd>
                <dd><span>身份证：</span><input type="text" name="baoxian_card_id" id="baoxian_card_id" value=""/></dd>
                <dd style="height:20px; line-height:20px;"><img src="/static/images/new_images/picc.jpg"
                                                                style="vertical-align:middle; margin-right:6px;"/>旧手机隐私信息泄露或运输丢失，人保理赔五千元
                </dd>
                ...
                <c:forEach items="${packageOrders}" var="packageorder">
                    <tr>
                        <td height="95" align="center">
                            <div class="contact_way_img"><img src="/static/images/goods/${packageorder.pmodel.modelImg}"
                                                              style="height: 50%"></div>
                            <div class="contact_way_txt" style="line-height: 3"><p>
                                <span>${packageorder.pmodel.modelName}</span></p></div>
                            <div class="clear"></div>
                        </td>
                        <td align="center" style="line-height:22px;">
                            <h3>${packageorder.lastPrice}</h3>
                        </td>
                        </td>
                    ...
                    <c:set var="zonePrice" value="${zonePrice+packageorder.lastPrice}"/>
                </c:forEach>
                </tbody>
            </table>
            <div class="foot_bor"><em>${packageOrders.size()}</em>件产品总计回收价格<em
                    style="font-size:18px;">￥${zonePrice}</em>
                <!--<span>赠送环保券 <i>30</i>元--></span></div>
        </div>
        <!--订单-->
        </div>
        <!--提交订单-->
